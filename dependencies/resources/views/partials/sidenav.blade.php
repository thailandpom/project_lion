<nav id="sidebar" aria-label="Main Navigation">
  ...
  <div class="bg-header-dark">
    <div class="content-header bg-white-10">
      <!-- Logo -->
      <a class="link-fx font-w600 font-size-lg text-dark" href="{{ route('pages.index') }}">
        <img class="img-logo" src="{{asset('front-ends-assets/images/lion.svg')}}" style="height: 64px;"> Jesdabet Lion
      </a>
